...
// Walls
const wallColorTexture = textureLoader.load("./walls/stone_wall_04_1k/stone_wall_04_diff_1k.webp")
const wallARMTexture = textureLoader.load("./walls/stone_wall_04_1k/stone_wall_04_arm_1k.webp")
const wallNormalTexture = textureLoader.load("./walls/stone_wall_04_1k/stone_wall_04_nor_gl_1k.webp")
...
for (let i = 0; i < 30; i++) {
    ...
    const radius = Math.random() * (7 - 3) + 3
...
scene.fog = new THREE.FogExp2("#12343f", 0.1)
...
const tick = () => {
    ...
    ghost1.position.y = Math.sin(ghost1Angle) * Math.sin(ghost1Angle * 2.34) * Math.sin(ghost1Angle * 3.31)


    const ghost2Angle = -elapsedTime * 0.38
    ghost2.position.x = Math.cos(ghost2Angle) * Math.cos(ghost2Angle * 2.34) * 7
    ghost2.position.z = Math.sin(ghost2Angle) * Math.sin(ghost2Angle * 2.34) * 7
    ghost2.position.y = Math.sin(ghost2Angle) * Math.sin(ghost2Angle * 2.34) * Math.sin(ghost2Angle * 3.31)


    const ghost3Angle = elapsedTime * 0.23
    ghost3.position.x = Math.cos(ghost3Angle) * 6
    ghost3.position.z = Math.sin(ghost3Angle) * 6
    ghost3.position.y = Math.sin(ghost3Angle) * Math.sin(ghost3Angle * 2.34) * Math.sin(ghost3Angle * 3.31)
